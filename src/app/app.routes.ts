...
export const routes: Routes = [
  ...
  {
    path: ':slug',
    loadComponent: () => import('./pages/feature/page/page.component').then(m => m.PageComponent),
...
export function multiSegmentMatcher(segments: UrlSegment[], group: UrlSegmentGroup, route: Route): UrlMatchResult | null {
